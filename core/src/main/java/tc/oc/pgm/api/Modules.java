...
public interface Modules {
  ...
  static void registerAll() {
    ...
    register(EditKitMatchModule.class, EditKitMatchModule::new);
    ...
    register(DyeColorMatchModule.class, DyeColorMatchModule::new);
    if (Bukkit.getPluginManager().getPlugin("Events") == null) {
      register(GlobalStatsMatchModule.class, GlobalStatsMatchModule::new);
    ...
    register(CPSMatchModule.class, CPSMatchModule::new);
