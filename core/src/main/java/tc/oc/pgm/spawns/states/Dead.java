...
public class Dead extends Spawning {
  ...
  private static final boolean DEATH_ANIMATION =
  ...
  public void enterState() {
    ...
    if (player.isVisible()) {
      if (DEATH_ANIMATION) NMSHacks.playDeathAnimation(player.getBukkit());
      else {
    ...
    // Show red vignette
    NMSHacks.showBorderWarning(bukkit, true);
  }
  ...
  public void tick() {
    ...
    if (!rotted && age >= CORPSE_ROT_TICKS && DEATH_ANIMATION) {
      this.rotted = true;
